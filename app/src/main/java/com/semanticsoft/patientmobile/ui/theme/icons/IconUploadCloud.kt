...
@Suppress("unused")
val IconUploadCloud: ImageVector
    get() {
        if (_IconUploadCloud != null) return _IconUploadCloud!!
        _IconUploadCloud = ImageVector.Builder(
        ...
        return _IconUploadCloud!!
    }

private var _IconUploadCloud: ImageVector? = null
